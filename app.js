...
function sumArray(testArray) { //eslint-disable-line
  var firstSum_1 = sum(testArray[0],testArray[1])[0];
  var secondSum_1 = sum(firstSum_1,testArray[2])[0];
  var string_4 = testArray + ' was passed in as an array of numbers, and ' + secondSum_1 + ' is their sum.';
  var sumArray = [];
  sumArray.push(secondSum_1, string_4);
  return sumArray;
}
...
function multiplyArray(testArray) { //eslint-disable-line
  var firstMultiply_1 = multiply(testArray[0],testArray[1])[0];
  var secondMultiply_1 = multiply(firstMultiply_1,testArray[2])[0];
  var string_5 = 'The numbers ' + testArray + ' have a product of ' + secondMultiply_1 + '.';
  var multiplyArray = [];
